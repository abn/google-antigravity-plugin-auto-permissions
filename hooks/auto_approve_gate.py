...
def main():
    ...
    try:
        ...
        # 9. Resolve configured classifier settings (provider, model, endpoint_url, api_key)
        ...
        # 11. Map classification verdict to Antigravity PreToolUse decision
        ...
        # 12. Asynchronously write rotatable audit record to session directory
        context_summary = {
        ...
        fallback_output = {
            "decision": "ask",
            "reason": f"Auto-permissions gate internal fallback: {exc}",
        }
